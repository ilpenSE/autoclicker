...
namespace AutoClicker
{
   ...
   LanguageMap.ToDictionary(kvp => kvp.Value, kvp => kvp.Key);
      ...
      public static readonly string VERSION_STRING = "1.3.4";
      ...
      private void RegisterChangeListeners()
      {
        ...
        this.holdForeverBtn.CheckedChanged += MarkAsUnsaved;
        this.holdTimeBtn.CheckedChanged += MarkAsUnsaved;
      }
      ...
      private void LoadMacroFormettings(string macroName)
      {
        try
        {
           ...
           bool isRepeatForever = macro.RepeatTimes.RepeatForever;
           bool isHoldForever = macro.HoldOptions.HoldForever;
           bool isCurrentPosition = macro.Position.CurrentPosition;

           posX.Value = macro.Position.X;
           posY.Value = macro.Position.Y;
           currentPosBtn.Checked = isCurrentPosition;
           specPosBtn.Checked = !isCurrentPosition;

           holdForeverBtn.Checked = isHoldForever;
           holdTimeBtn.Checked = !isHoldForever;

           try { hdMillis.Value = macro.HoldOptions.Duration; }
      ...
      private void SaveCurrentMacro()
      {
        ...
        var macro = new MacroModel
        {
           ...
           HoldOptions = new HoldOpts
           {
              HoldForever = holdForeverBtn.Checked,
              Duration = (int)hdMillis.Value
           }
        };
      ...
      holdTimeBtn.Text = Resources.hold_htime;
      holdForeverBtn.Text = Resources.hold_forever;
      ...
      private void StartAutoClicker()
      {
        ...
        if (interval <= 0) interval = MacroManager.DefaultInterval;

        int holdDuration = GetHoldDurationInMillis();
        if (holdDuration <= 0) holdDuration = MacroManager.DefaultHoldOptions.Duration;
