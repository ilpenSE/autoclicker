...
HotkeyService::HotkeyService(QObject* parent)
    : QObject(parent),
      m_nextHotkeyId(1000)  // Start from 1000 to avoid conflicts
{
...
bool HotkeyService::registerHotkey(const QString& hotkeyString, int id) {
  ...
  hsinfo() << "Hotkey registered successfully: " << hotkeyString
           << " with ID: " << id;
  return true;
}
...
bool HotkeyService::isHotkeyRegistered(int id) const {
  return m_registeredHotkeys.contains(id) &&
         m_registeredHotkeys[id].isRegistered;
}
...
bool HotkeyService::parseHotkeyString(const QString& hotkeyString,
                                      Qt::KeyboardModifiers& modifiers,
                                      int& key) {
  ...
  QMap<QString, Qt::Key> keyMap = {
      {"A", Qt::Key_A},           {"B", Qt::Key_B},
      {"C", Qt::Key_C},           {"D", Qt::Key_D},
      {"E", Qt::Key_E},           {"F", Qt::Key_F},
      {"G", Qt::Key_G},           {"H", Qt::Key_H},
      {"I", Qt::Key_I},           {"J", Qt::Key_J},
      {"K", Qt::Key_K},           {"L", Qt::Key_L},
      {"M", Qt::Key_M},           {"N", Qt::Key_N},
      {"O", Qt::Key_O},           {"P", Qt::Key_P},
      {"Q", Qt::Key_Q},           {"R", Qt::Key_R},
      {"S", Qt::Key_S},           {"T", Qt::Key_T},
      {"U", Qt::Key_U},           {"V", Qt::Key_V},
      {"W", Qt::Key_W},           {"X", Qt::Key_X},
      {"Y", Qt::Key_Y},           {"Z", Qt::Key_Z},
      {"0", Qt::Key_0},           {"1", Qt::Key_1},
      {"2", Qt::Key_2},           {"3", Qt::Key_3},
      {"4", Qt::Key_4},           {"5", Qt::Key_5},
      {"6", Qt::Key_6},           {"7", Qt::Key_7},
      {"8", Qt::Key_8},           {"9", Qt::Key_9},
      {"SPACE", Qt::Key_Space},   {"TAB", Qt::Key_Tab},
      {"ESCAPE", Qt::Key_Escape}, {"BACKSPACE", Qt::Key_Backspace},
      {"DELETE", Qt::Key_Delete}, {"INSERT", Qt::Key_Insert},
...
QString HotkeyService::formatHotkeyString(Qt::KeyboardModifiers modifiers,
                                          int key) {
  QStringList parts;
...
void HotkeyService::cleanup() { unregisterAllHotkeys(); }

#ifdef Q_OS_WIN
bool HotkeyService::nativeEventFilter(const QByteArray& eventType,
...
bool HotkeyService::registerNativeHotkey(int id,
                                         Qt::KeyboardModifiers modifiers,
                                         int key) {
...
QStringList HotkeyService::getSupportedKeys() const {
  return QStringList{
      ...
      // Special keys
      "SPACE", "TAB", "ESCAPE", "BACKSPACE", "DELETE", "INSERT", "HOME", "END",
